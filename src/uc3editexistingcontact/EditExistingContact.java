package uc3editexistingcontact;

import uc1createcontact.CreateContact;
...
public class EditExistingContact {
    ...
    public void editName() {
        ...
        for(int i=0; i< person.size();i++) {
            CreateContact name = person.get(i);
    ...
    public static void main(String[] args) {
        ...
        CreateContact cont = new CreateContact("aaqib ", "ansari ", "Dhule ", "Dhule ", "Maharastra ", "424005 ", "12345 ",
                "aaqi@gmail.com ");
